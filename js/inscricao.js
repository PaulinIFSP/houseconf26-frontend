/* HOUSE CONF 26 — Fluxo de inscrição completo
   - responsável + participantes para combos
   - escolha de forma de pagamento antes do checkout
   - código oficial HC26-XXXX
   - envio para Apps Script/Sheets e backend Mercado Pago
*/
(function () {
  'use strict';
